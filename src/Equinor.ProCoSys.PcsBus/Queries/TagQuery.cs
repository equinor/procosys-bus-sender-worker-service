...
//Currently not used in the BusSender service itself, but only by FamFeeder.
//Tag message in the busevent table is a "thick" message generated by the Tag bus trigger
...
public class TagQuery
{
    public static (string query, DynamicParameters parameters) GetQuery(long? tagId, string? plant = null)
    {
        ...
        from tag t
            ...
            left join library contractor on contractor.library_id = t.contractor_id
